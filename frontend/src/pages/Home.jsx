        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-3 cursor-pointer">
              ...
              <span className="text-2xl font-extrabold text-slate-800 tracking-tight">ATMS <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Portal</span></span>
            </div>
      ...
      <footer className="bg-slate-900 border-t border-slate-800 text-slate-400 py-12 text-center">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-center items-center gap-2 mb-4 opacity-50">
            ...
            <span className="text-xl font-extrabold tracking-tight text-white">ATMS</span>
          </div>
