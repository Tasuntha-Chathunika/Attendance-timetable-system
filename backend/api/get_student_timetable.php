...
// In this simple system, all students take all courses.
// We just return the full timetable.
$sql = "SELECT 
            t.id, 
            c.course_name, 
            c.course_code, 
...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        http_response_code(200);
        echo json_encode(["status" => "success", "data" => [], "message" => "No classes scheduled yet."]);
    }
} else {
